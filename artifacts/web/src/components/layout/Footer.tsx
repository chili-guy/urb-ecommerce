        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <Link href="/" className="flex items-center">
              <img src="/images/jurb-logo-full.png" alt="JURB Comércio de Eletrônicos" className="w-[150px]" />
            </Link>
         ...
         <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-[#111820]/15 pt-8 text-xs text-[#4f585d] md:flex-row">
           <p>© {new Date().getFullYear()} JURB Comércio de Eletrônicos. Todos os direitos reservados.</p>
